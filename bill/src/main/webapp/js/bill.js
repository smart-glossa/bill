					...
					$(document)
							.on(
									...
									function() {
										...
										var url = "http://localhost:8080/bill/bill?operation=addProduct&pid="
												+ pId
												+ "&pname="
												+ pName
												+ "&cost=" + cost;
					...
					$(document)
							.on(
									...
									function(key) {
										...
										var div = $(this).parent();
										var getProductUrl = "/bill/bill?operation=getProduct&pid="
												+ $(this).val();
										$
												.ajax({
													url : getProductUrl,
					...
					$(document)
							.on(
									...
									function() {
										...
										var pName = $('#pName').val();
										var cost = $('#cost').val();
										var url = "http://localhost:8080/bill/bill?operation=updateProduct&pid="
												+ pId
												+ "&name="
												+ pName
												+ "&cost=" + cost;
					...
					$(document)
							.on(
									...
									function() {
										var tag = $(this);
										var pid = $(this)
												.children(".productId")[0].innerHTML;
										var url = "/bill/bill?operation=deleteProduct&pid="
												+ pid
										$.ajax({
											url : url,
											type : 'POST'
